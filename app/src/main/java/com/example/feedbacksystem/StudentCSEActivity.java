...
public class StudentCSEActivity extends AppCompatActivity {

    private LinearLayout teacherLayout;
    private DatabaseReference databaseCSE; // Change the reference to CSE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finishButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(StudentCSEActivity.this, MainActivity.class);
    ...
    private void fetchTeachers() {
        databaseCSE.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(StudentCSEActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addTeacherToLayout(Teacher teacher, String teacherId) {
        ...
        submitRatingButton.setOnClickListener(v -> {
            ...
            if (rating > 0) {
                // Store the rating in Firebase under a separate node (e.g., /CSE/ratings)
                databaseCSE.child(teacherId).child("ratings").push().setValue(rating)
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                Toast.makeText(StudentCSEActivity.this, "Rating submitted", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(StudentCSEActivity.this, "Failed to submit rating", Toast.LENGTH_SHORT).show();
                            }
                        });
            } else {
                Toast.makeText(StudentCSEActivity.this, "Please select a rating", Toast.LENGTH_SHORT).show();
            }
        });
